...
/*!
	@param	|layer| could be the host that spawned it or an intermediate object.
 */
...
/*!
	@brief	This method is paired with <tt>-layerDidOpen:</tt> and MUST be sent AFTER it.
...
/*!
	@brief	This method is paired with <tt>-layerDidClose:</tt> and MUST be sent BEFORE it.
	@detail	This method signals disconnection in both clean and dirty conditions, the |error| argument will be nil to signify a clean disconnection.
