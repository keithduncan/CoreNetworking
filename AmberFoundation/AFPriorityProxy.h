...
/*!
	@brief	This proxy allows for more complex message routing
	@detail	It is recursive-safe, whilst a routed method is on the stack it won't be called again.
...
/*!
	@brief	Designated Initialiser.
			Unlike the superclass which doesn't specify an instantiator this class does.
 */
- (id)init;

/*!
	@brief	Target priority is enumerated low to high.
