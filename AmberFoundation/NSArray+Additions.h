...
/*!
	@brief	This returns whether or not it is safe to use <tt>-objectAtIndex:</tt> for a given index.
 */
...
/*!
	@brief	This returns nil of the index isn't present in the array.
 */
...
/*!
	@brief	This returns the only object in the array, or nil if the receiver contains more than one object.
 */
- (id)onlyObject;
