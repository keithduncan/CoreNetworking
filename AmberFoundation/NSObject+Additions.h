...
//	Execution doesn't yield to the main thread so be careful what you do with return values of methods called on -threadProxy
...
- (id)protocolProxy:(Protocol *)protocol; // Note: only selectors that return true for -respondsToSelector: will be forwarded allowing you to send unimplemented selectors
